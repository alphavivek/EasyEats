...
import logo from './images/EasyEats_Logo.png';
...
const RestaurantCard = (props) => {
  ...
  const{cloudinaryImageId, name,cuisines, avgRating, deliveryTime, costForTwo} = restroData?.data;
  
  return(
    <div className="restro-card" style={{
      backgroundColor: "#f0f0f0"
    }}>
      <img className="Restro_logo" src={"https://media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_660/" + cloudinaryImageId} alt="Meghana Food" />
      <h3>{name}</h3>
      <h4>{cuisines.join(", ")}</h4>
  ...
  return(
    <div className="body">
      ...
      <div className="restro_container">
        {/* <RestaurantCard restroData = {restaurantList}/> */}
        {/* <RestaurantCard restroname="KFC" cuisine="Maharaja Burger, Fast Food"/> */}
